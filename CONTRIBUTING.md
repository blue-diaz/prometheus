...
git remote add upstream https://github.com/blue-diaz/prometheus.git
```
...
- Issues com label [`bug`](https://github.com/blue-diaz/prometheus/labels/bug)
- Issues com label [`good-first-issue`](https://github.com/blue-diaz/prometheus/labels/good-first-issue)
