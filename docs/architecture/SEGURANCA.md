...
- [ERRO] **Plugins externos desabilitados**
- [ERRO] **Execução de comandos bloqueada**
- [ERRO] **Modificações no filesystem limitadas**
- [ERRO] **Auto-fix estrutural desabilitado**
...
```typescript
// [ERRO] Vulnerável - backtracking exponencial
const regex = /(a+)+$/;
